...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Rasio Aktivitas | Average Day's Inventory</title>
	...
	<body class="kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
								...
								<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open kt-menu__item--here" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item kt-menu__item--active" aria-haspopup="true"><a href="<?php echo base_url();?>average-days-inventory/" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Average Day's Inventory</span></a></li>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="kt-portlet">
										...
										<form class="kt-form" id="averagedaysinventory" method="post" target="form">
											<div class="kt-portlet__body">
												...
												<div class="form-group">
													<label>Inventory Rata-Rata</label>
													<input type="number" class="form-control" name="inventoryratarata" id="inventoryratarata" placeholder="Masukkan Nilai Inventory Rata-Rata">
												</div>
												<div class="form-group">
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$( "#averagedaysinventory" ).validate( {
		        rules: {
		            hargapokokpenjualan: "required",
		            inventoryratarata: "required"
		        },
		        messages: {
		            hargapokokpenjualan: "Silakan masukkan nilai harga pokok penjualan Anda",
		            inventoryratarata: "Silakan masukkan nilai inventory rata-rata Anda"
		        },
		        errorElement: "em",
		    	...
		    	$("#hitung").click(function(){
			        if ($("#hargapokokpenjualan").val()!="" && $("#inventoryratarata").val()!=""){
			            $.ajax({
			                url : "<?php echo base_url();?>perhitungan/averagedaysinventory/",
			                type: "POST",
			                dataType:'json',
			                data:$('#averagedaysinventory').serialize(),
			                beforeSend: function(){
