...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Rasio Likuiditas | Current Ratio</title>
	...
	<body class="kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
								...
								<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open kt-menu__item--here" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="<?php echo base_url();?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Current Ratio</span></a></li>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="kt-portlet">
										...
										<form class="kt-form" id="currentratio" method="post" target="form">
											...
											<div class="kt-portlet__foot">
												<div class="kt-form__actions">
													<button class="btn btn-primary" name="currentratiobutton" id="currentratiobutton">Hitung</button>
		...
		<script type="text/javascript">
			$(document).ready(function() {
		    	...
		    	$("#currentratiobutton").click(function(){
			        if ($("#aktivalancar").val()!="" && $("#hutanglancar").val()!=""){
			            $.ajax({
			                url : "<?php echo base_url();?>perhitungan/currentratio/",
			                type: "POST",
			                dataType:'json',
			                data:$('#currentratio').serialize(),
			                beforeSend: function(){
