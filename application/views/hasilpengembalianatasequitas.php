...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Rasio Profobilitas | Hasil Pengembalian Atas Equitas / Return on Equity Hasil Pengembalian Atas Equitas</title>
	...
	<body class="kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
								...
								<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open kt-menu__item--here" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item kt-menu__item--active" aria-haspopup="true"><a href="<?php echo base_url();?>hasil-pengembalian-atas-equitas/" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Hasil Pengembalian Atas Equitas</span></a></li>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">
                                                    Hasil Pengembalian Atas Equitas / Return on Equity Hasil Pengembalian Atas Equitas
												</h3>
											</div>
										</div>
										...
										<form class="kt-form" id="hasilpengembalianatasequitas" method="post" target="form">
											<div class="kt-portlet__body">
												...
												<div class="form-group">
													...
													<input type="number" class="form-control" name="lababersih" id="lababersih" placeholder="Masukkan Nilai Laba Bersih">
												</div>
												<div class="form-group">
													<label>Equitas Pemegang Saham</label>
													<input type="number" class="form-control" name="equitaspemegangsaham" id="equitaspemegangsaham" placeholder="Masukkan Nilai Equitas Pemegang Saham">
												</div>
												<div class="form-group">
													<div id="hasil"></div>
													<div id="error"></div>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$( "#hasilpengembalianatasequitas" ).validate( {
		        rules: {
		            lababersih: "required",
		            equitaspemegangsaham: "required"
		        },
		        messages: {
		            lababersih: "Silakan masukkan nilai laba bersih Anda",
                    equitaspemegangsaham: "Silakan masukkan nilai equitas pemegang saham Anda"
		        },
		        errorElement: "em",
		    	...
		    	$("#hitung").click(function(){
			        if ($("#lababersih").val()!="" && $("#equitaspemegangsaham").val()!=""){
			            $.ajax({
			                url : "<?php echo base_url();?>perhitungan/hasilpengembalianatasequitas/",
			                type: "POST",
			                dataType:'json',
			                data:$('#hasilpengembalianatasequitas').serialize(),
			                beforeSend: function(){
