...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Rasio Profobilitas | Hasil Pengembalian Marginal Atas Equitas / Marginal (Return to Equity)</title>
								...
								<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open kt-menu__item--here" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item kt-menu__item--active" aria-haspopup="true"><a href="<?php echo base_url();?>hasil-pengembalian-marginal-atas-equitas/" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Hasil Pengembalian Marginal Atas Equitas</span></a></li>
										</ul>
									</div>
								</li>
                                <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">
                                                    Hasil Pengembalian Marginal Atas Equitas / Marginal (Return to Equity)
												</h3>
											</div>
										</div>
										...
										<form class="kt-form" id="hasilpengembalianmarginalatasequitas" method="post" target="form">
...
<!--												</div>-->
												<div class="form-group">
													<label>Perubahan NI</label>
													<input type="number" class="form-control" name="perubahanni" id="perubahanni" placeholder="Masukkan Nilai Perubahan NI">
												</div>
												<div class="form-group">
													<label>Perubahan Equitas</label>
													<input type="number" class="form-control" name="perubahanequitas" id="perubahanequitas" placeholder="Masukkan Nilai Perubahan Equitas">
												</div>
												<div class="form-group">
													<div id="hasil"></div>
													<div id="error"></div>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$( "#hasilpengembalianmarginalatasequitas" ).validate( {
		        rules: {
		            perubahanni: "required",
                    perubahanequitas: "required"
		        },
		        messages: {
                    perubahanni: "Silakan masukkan nilai perubahan NI Anda",
                    perubahanequitas: "Silakan masukkan nilai perubahan equitas Anda"
		        },
		        errorElement: "em",
		    	...
		    	$("#hitung").click(function(){
			        if ($("#perubahanni").val()!="" && $("#perubahanequitas").val()!=""){
			            $.ajax({
			                url : "<?php echo base_url();?>perhitungan/hasilpengembalianmarginalatasequitas/",
			                type: "POST",
			                dataType:'json',
			                data:$('#hasilpengembalianmarginalatasequitas').serialize(),
			                beforeSend: function(){
