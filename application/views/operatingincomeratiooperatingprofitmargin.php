...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Rasio Keuntungan | Operating Income Ratio (Operating Profit Margin)</title>
	...
	<body class="kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
								...
								<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open kt-menu__item--here" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item kt-menu__item--active" aria-haspopup="true"><a href="<?php echo base_url();?>operating-income-ratio-operating-profit-margin/" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Operating Income Ratio (Operating Profit Margin)</span></a></li>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="kt-portlet">
										...
										<form class="kt-form" id="operatingincomeratiooperatingprofitmargin" method="post" target="form">
											<div class="kt-portlet__body">
												...
												<div class="form-group">
													<label>Penjualan Neto</label>
													<input type="number" class="form-control" name="penjualanneto" id="penjualanneto" placeholder="Masukkan Nilai Penjualan Neto">
												</div>
												<div class="form-group">
													<label>Harga Pokok Penjualan</label>
													<input type="number" class="form-control" name="hargapokokpenjualan" id="hargapokokpenjualan" placeholder="Masukkan Nilai Harga Pokok Penjualan">
												</div>
												<div class="form-group">
													<label>Biaya Admin dan Umum</label>
													<input type="number" class="form-control" name="biayaadmindanumum" id="biayaadmindanumum" placeholder="Masukkan Nilai Biaya Admin dan Umum">
												</div>
												<div class="form-group">
													<div id="hasil"></div>
													<div id="error"></div>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$( "#operatingincomeratiooperatingprofitmargin" ).validate( {
		        rules: {
		            penjualanneto: "required",
		            hargapokokpenjualan: "required",
		            biayaadmindanumum: "required"
		        },
		        messages: {
		            penjualanneto: "Silakan masukkan nilai penjualan neto Anda",
		            hargapokokpenjualan: "Silakan masukkan nilai harga pokok penjualan Anda",
		            biayaadmindanumum: "Silakan masukkan nilai biaya admin dan umum Anda"
		        },
		        errorElement: "em",
		    	...
		    	$("#hitung").click(function(){
			        if ($("#penjualanneto").val()!="" && $("#hargapokokpenjualan").val()!="" && $("#biayaadmindanumum").val()!=""){
			            $.ajax({
			                url : "<?php echo base_url();?>perhitungan/operatingincomeratiooperatingprofitmargin/",
			                type: "POST",
			                dataType:'json',
			                data:$('#operatingincomeratiooperatingprofitmargin').serialize(),
			                beforeSend: function(){
