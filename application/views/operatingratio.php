...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Rasio Keuntungan | Operating Ratio</title>
								...
								<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open kt-menu__item--here" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item kt-menu__item--active" aria-haspopup="true"><a href="<?php echo base_url();?>operating-ratio/" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Operating Ratio</span></a></li>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="kt-portlet">
										...
										<form class="kt-form" id="operatingratio" method="post" target="form">
			...
			$(document).ready(function() {
		    	...
		    	$("#hitung").click(function(){
			        if ($("#penjualanneto").val()!="" && $("#hargapokokpenjualan").val()!="" && $("#biayaadmindanumum").val()!=""){
			            $.ajax({
			                url : "<?php echo base_url();?>perhitungan/operatingratio/",
			                type: "POST",
			                dataType:'json',
			                data:$('#operatingratio').serialize(),
			                beforeSend: function(){
