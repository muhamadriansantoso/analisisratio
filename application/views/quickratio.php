...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Rasio Likuiditas | Quick Ratio (Acid Test Ratio)</title>
	...
	<body class="kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
								...
								<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open kt-menu__item--here" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item kt-menu__item--active" aria-haspopup="true"><a href="<?php echo base_url();?>quick-ratio-acid-test-ratio/" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Quick Ratio (Acid Test Ratio)</span></a></li>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="kt-portlet">
										...
										<form class="kt-form" id="quickratio" method="post" target="form">
											<div class="kt-portlet__body">
												...
												<div class="form-group">
													<label>Kas</label>
													<input type="number" class="form-control" name="kas" id="kas" placeholder="Masukkan Nilai Kas">
												</div>
												<div class="form-group">
													<label>Efek</label>
												...
												<div class="form-group">
													<label>Hutang</label>
													<input type="number" class="form-control" name="hutang" id="hutang" placeholder="Masukkan Nilai Hutang">
												</div>
												<div class="form-group">
		...
		<script type="text/javascript">
			$(document).ready(function() {
		        ...
		        messages: {
		            kas: "Silakan masukkan nilai kas Anda",
		            efek: "Silakan masukkan nilai efek Anda",
		            hutang: "Silakan masukkan nilai hutang Anda",
		    	...
		    	$("#hitung").click(function(){
			        if ($("#kas").val()!="" && $("#efek").val()!="" && $("#hutang").val()!="" && $("#hutanglancar").val()!=""){
			            $.ajax({
			                url : "<?php echo base_url();?>perhitungan/quickratio/",
			                type: "POST",
			                dataType:'json',
			                data:$('#quickratio').serialize(),
			                beforeSend: function(){
