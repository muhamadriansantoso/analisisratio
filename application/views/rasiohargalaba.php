...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Rasio Penilaian | Rasio Harga/Laba Harga Pasar per Saham Terhadap Laba per Saham (Price/Earning Ratio atau P/E Ratio)</title>
	...
	<body class="kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
						...
						<div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
							<ul class="kt-menu__nav ">
								...
								<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open kt-menu__item--here" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											<li class="kt-menu__item kt-menu__item--active" aria-haspopup="true"><a href="<?php echo base_url();?>rasio-harga-laba/" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Rasio Harga/Laba</span></a></li>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">
                                                    Rasio Harga/Laba Harga Pasar per Saham Terhadap Laba per Saham (Price/Earning Ratio atau P/E Ratio)
												</h3>
											</div>
										</div>
										...
										<form class="kt-form" id="rasiohargalaba" method="post" target="form">
											<div class="kt-portlet__body">
												...
												<div class="form-group">
													<label>Harga Pasar per Saham</label>
													<input type="number" class="form-control" name="hargapasarpersaham" id="hargapasarpersaham" placeholder="Masukkan Nilai Harga Pasar per Saham">
												</div>
												<div class="form-group">
													<label>Laba per Saham</label>
													<input type="number" class="form-control" name="labapersaham" id="labapersaham" placeholder="Masukkan Nilai Laba per Saham">
												</div>
												<div class="form-group">
													<div id="hasil"></div>
													<div id="error"></div>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$( "#rasiohargalaba" ).validate( {
		        rules: {
                    hargapasarpersaham: "required",
                    labapersaham: "required"
		        },
		        messages: {
                    hargapasarpersaham: "Silakan masukkan nilai harga per saham Anda",
                    labapersaham: "Silakan masukkan nilai laba per saham Anda"
		        },
		        errorElement: "em",
		    	...
		    	$("#hitung").click(function(){
			        if ($("#hargapasarpersaham").val()!="" && $("#labapersaham").val()!=""){
			            $.ajax({
			                url : "<?php echo base_url();?>perhitungan/rasiohargalaba/",
			                type: "POST",
			                dataType:'json',
			                data:$('#rasiohargalaba').serialize(),
			                beforeSend: function(){
