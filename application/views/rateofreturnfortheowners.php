...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Rasio Keuntungan | Rate of Return for the Owners (Rate of Return on Net Worth)</title>
	...
	<body class="kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
								...
								<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open kt-menu__item--here" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item kt-menu__item--active"" aria-haspopup="true"><a href="<?php echo base_url();?>rate-of-return-for-the-owners/" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Rate of Return for the Owners</span></a></li>
										</ul>
									</div>
								</li>
								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="kt-portlet">
										...
										<form class="kt-form" id="rateofreturnfortheowners" method="post" target="form">
											<div class="kt-portlet__body">
												...
												<div class="form-group">
													<label>ML Modal Sendiri</label>
													<input type="number" class="form-control" name="mlmodalsendiri" id="mlmodalsendiri" placeholder="Masukkan Nilai ML Modal Sendiri">
												</div>
												<div class="form-group">
													<div id="hasil"></div>
													<div id="error"></div>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$( "#rateofreturnfortheowners" ).validate( {
		        rules: {
		            earningaftertax: "required",
		            mlmodalsendiri: "required"
		        },
		        messages: {
		            earningaftertax: "Silakan masukkan nilai earning after tax Anda",
		            mlmodalsendiri: "Silakan masukkan nilai ML modal sendiri Anda"
		        },
		        errorElement: "em",
		    	...
		    	$("#hitung").click(function(){
			        if ($("#earningaftertax").val()!="" && $("#mlmodalsendiri").val()!=""){
			            $.ajax({
			                url : "<?php echo base_url();?>perhitungan/rateofreturnfortheowners/",
			                type: "POST",
			                dataType:'json',
			                data:$('#rateofreturnfortheowners').serialize(),
			                beforeSend: function(){
