...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Rasio Leverage | Tangible Assets Debt Coverage</title>
	...
	<body class="kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
								...
								<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open kt-menu__item--here" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item kt-menu__item--active" aria-haspopup="true"><a href="<?php echo base_url();?>tangible-assets-debt-coverage/" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Tangible Assets Debt Coverage</span></a></li>
								...
								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo base_url();?>laba-operasi-bersih-terhadap-total-modal/" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Laba Operasi Bersih Terhadap Total Modal</span></a></li>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="kt-portlet">
										...
										<form class="kt-form" id="tangibleassetsdebtcoverage" method="post" target="form">
											<div class="kt-portlet__body">
												...
												<div class="form-group">
													<label>Jumlah Aktiva</label>
													<input type="number" class="form-control" name="jumlahaktiva" id="jumlahaktiva" placeholder="Masukkan Nilai Jumlah Aktiva">
												</div>
												<div class="form-group">
													<label>Intangibles</label>
													<input type="number" class="form-control" name="intangibles" id="intangibles" placeholder="Masukkan Nilai Intangibles">
												</div>
												<div class="form-group">
													<label>Hutang Lancar</label>
													<input type="number" class="form-control" name="hutanglancar" id="hutanglancar" placeholder="Masukkan Nilai Hutang Lancar">
												</div>
												<div class="form-group">
													<label>Hutang Jangka Panjang</label>
													<input type="number" class="form-control" name="hutangjangkapanjang" id="hutangjangkapanjang" placeholder="Masukkan Nilai Hutang Jangka Panjang">
												</div>
												<div class="form-group">
													<div id="hasil"></div>
													<div id="error"></div>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$( "#tangibleassetsdebtcoverage" ).validate( {
		        rules: {
		            jumlahaktiva: "required",
		            intangibles: "required",
		            hutanglancar: "required",
		            hutangjangkapanjang: "required"
		        },
		        messages: {
		            jumlahaktiva: "Silakan masukkan nilai jumlah aktiva Anda",
		            intangibles: "Silakan masukkan nilai intangibles Anda",
		            hutanglancar: "Silakan masukkan nilai hutang lancar Anda",
		            hutangjangkapanjang: "Silakan masukkan nilai hutang jangka panjang Anda"
		        },
		        errorElement: "em",
		    	...
		    	$("#hitung").click(function(){
			        if ($("#jumlahaktiva").val()!="" && $("#intangibles").val()!="" && $("#hutanglancar").val()!="" && $("#hutangjangkapanjang").val()!=""){
			            $.ajax({
			                url : "<?php echo base_url();?>perhitungan/tangibleassetsdebtcoverage/",
			                type: "POST",
			                dataType:'json',
			                data:$('#tangibleassetsdebtcoverage').serialize(),
			                beforeSend: function(){
