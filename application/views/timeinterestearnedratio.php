...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Rasio Leverage | Times Interest Earned Ratio</title>
	...
	<body class="kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
								...
								<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open kt-menu__item--here" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item kt-menu__item--active" aria-haspopup="true"><a href="<?php echo base_url();?>time-interest-earned-ratio/" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Time Interest Earned Ratio</span></a></li>
										</ul>
									</div>
								</li>
								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="kt-portlet">
										...
										<form class="kt-form" id="timeinterestearnedratio" method="post" target="form">
											<div class="kt-portlet__body">
												...
												<div class="form-group">
													<label>Bunga Hutang Jangka Panjang</label>
													<input type="number" class="form-control" name="bungahutangjangkapanjang" id="bungahutangjangkapanjang" placeholder="Masukkan Nilai Bunga Hutang Jangka Panjang">
												</div>
												<div class="form-group">
													<div id="hasil"></div>
													<div id="error"></div>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$( "#timeinterestearnedratio" ).validate( {
		        rules: {
		            ebit: "required",
		            bungahutangjangkapanjang: "required"
		        },
		        messages: {
		            ebit: "Silakan masukkan nilai EBIT Anda",
		            bungahutangjangkapanjang: "Silakan masukkan nilai bunga hutang jangka panjang Anda"
		        },
		        errorElement: "em",
		    	...
		    	$("#hitung").click(function(){
			        if ($("#ebit").val()!="" && $("#bungahutangjangkapanjang").val()!=""){
			            $.ajax({
			                url : "<?php echo base_url();?>perhitungan/timeinterestearnedratio/",
			                type: "POST",
			                dataType:'json',
			                data:$('#timeinterestearnedratio').serialize(),
			                beforeSend: function(){
