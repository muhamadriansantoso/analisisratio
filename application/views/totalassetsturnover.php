...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Rasio Aktivitas | Total Assets Turn Over</title>
						...
						<div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
							<ul class="kt-menu__nav ">
								...
								<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open kt-menu__item--here" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											<li class="kt-menu__item kt-menu__item--active" aria-haspopup="true"><a href="<?php echo base_url();?>total-assets-turn-over/" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Total Assets Turn Over</span></a></li>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="kt-portlet">
										...
										<form class="kt-form" id="totalassetsturnover" method="post" target="form">
											<div class="kt-portlet__body">
												...
												<div class="form-group">
													...
													<input type="number" class="form-control" name="jumlahaktiva" id="jumlahaktiva" placeholder="Masukkan Nilai Bunga Hutang Jumlah Aktiva">
												</div>
												<div class="form-group">
													<div id="hasil"></div>
													<div id="error"></div>
		...
		<script type="text/javascript">
			$(document).ready(function() {
		    	...
		    	$("#hitung").click(function(){
			        if ($("#penjualanneto").val()!="" && $("#jumlahaktiva").val()!=""){
			            $.ajax({
			                url : "<?php echo base_url();?>perhitungan/totalassetsturnover/",
			                type: "POST",
			                dataType:'json',
			                data:$('#totalassetsturnover').serialize(),
			                beforeSend: function(){
